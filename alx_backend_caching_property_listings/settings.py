...
from properties.utilities import verify_os_variables
...
SECRET_KEY = "django-insecure-#uktke76tgp&5(dr5l!s5x021sgy)7x*&6^naq320e^#s#f!do"
...
INSTALLED_APPS = [
    ...
    "properties.app.PropertiesConfig",
    "rest_framework",
    "graphene_django",
    "django_redis"
]
...
DATABASES = {
    "default": {
        ...
        "NAME": verify_os_variables('DB_NAME'),
